<%-- 
    Document   : pay
    Created on : 13 Aug, 2022, 9:54:59 PM
    Author     : Ruler
--%>
                        ...
                        <div class="collapse show p-3 pt-0" id="collapseExample">
                            <div class="row">
                                <div class="col-lg-5 mb-lg-0 mb-3">
                                    <p class="h4 mb-0">Summary</p>
                                    <p class="mb-0"><span class="fw-bold">Product:</span><span class="c-green"> Donate</span>
                                    </p>
                                    
                                </div>
                                <div class="col-lg-7">
                                    <form action="addDonate.jsp" method="post" class="form">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form__div">
                                            ...
                                            <div class="col-12">
                                                <div class="form__div">
                                                    <input type="number" class="form-control" name='donate' placeholder=" ">
