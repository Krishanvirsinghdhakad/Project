...
<body>
    ...
    %>
        ...
        <%
            ...
            ResultSet rs = stmt. executeQuery("select * from tbl_news");
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content ">
				<div class="container-fluid p-0">
                                    <div class="row">
                                        <div class="col-10">
                                            <h1 class="h3 mb-3"><strong>News</strong> Details</h1>
                                        </div>
                                        <div class="col-2">
                                            <button class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><i class="fa fa-plus"></i> Add</button>
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="action/AddNews.jsp">
                                                        <div class="form-group">
                                                          <label for="recipient-name" class="col-form-label">Title:</label>
                                                          <input type="text" class="form-control form-control-sm" name="title" required id="recipient-name">
                                                        </div>
                                                        <div class="form-group">
                                                          <label for="message-text" class="col-form-label">Para 1:</label>
                                                          <textarea class="form-control form-control-sm" id="message-text" required name="para1"></textarea>
                                                        </div>
                                                          <div class="form-group">
                                                          <label for="message-text" class="col-form-label">Para 2:</label>
                                                          <textarea class="form-control form-control-sm" id="message-text" required name="para2"></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                          <label for="message-text" class="col-form-label" name="para3">Para 3:</label>
                                                          <textarea required class="form-control form-control-sm" id="message-text" name="para3"></textarea>
                                                        </div>
                                                        <div class="form-group">
						...
						<table class="table" id='myTable'>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td><%=rs.getString("para1")%></td>
                                                      <td><%=rs.getString("para2")%></td>
                                                      <td><%=rs.getString("date").split(" ")[0]%></td>
                                                      
                                                      <td><button class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></button>
                                                          <a href="action/DelNews.jsp?id=<%=rs.getString("id")%>" class="btn btn-secondary btn-sm"><i class="fa fa-trash"></i></a>
                                                      </td>
